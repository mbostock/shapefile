...
suite.addBatch({
  "A simple shapefile of points": {
    ...
    "has the expected bounding box": function(result) {
      assert.deepEqual(result.bbox, [1, 2, 17, 18]);
    },
    "has the expected points": function(result) {
      assert.deepEqual(result.geometries, [
        ...
        {type: "Point", coordinates: [13, 14]},
        {type: "Point", coordinates: [15, 16]},
